...
import { getComponent } from '@stackbit/component/components-registry.ts';
import { mapStylesToClassNames as mapStyles } from '@stackbit/component/utils/map-styles-to-class-names.ts';
